/*
  ...
  - Added the required column `APARELHO_ID` to the `VEICULO` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_VEICULO" ("ID", "MOTORISTA_CODIGO", "TIPO_CODIGO") SELECT "ID", "MOTORISTA_CODIGO", "TIPO_CODIGO" FROM "VEICULO";
DROP TABLE "VEICULO";
